...
def read_dataset(path):
    ...
    for _, row in df.iterrows():
        token_docs.append(ast.literal_eval(row['sentence']))
        tag_docs.append(ast.literal_eval(row['sentiment_id']))
...
data_read = read_dataset("E:\Projects\A_Idiom_detection_gihan\idiom_detection_nlp\\building_emotional_embeddings\data\sentences_wc.csv")
...
train_encodings = tokenizer(train_texts, padding=True,truncation=True, max_length=30)
val_encodings = tokenizer(val_texts, padding=True, truncation=True, max_length=30)
