...
test_data_read = read_dataset("..\Idiom_scraper\with_tags_theidioms.com.csv")
test_token_docs = test_data_read[0]
test_tag_docs = test_data_read[1]

# train_texts, val_texts, train_tags, val_tags = train_test_split(token_docs, tag_docs, test_size=.2, random_state=29)
train_texts, val_texts, train_tags, val_tags = train_token_docs, test_token_docs, train_tag_docs, test_tag_docs
